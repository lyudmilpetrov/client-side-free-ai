...
const MODELS = [
  {
    url:
      "https://huggingface.co/afrideva/TinyMistral-248M-SFT-v4-GGUF/resolve/main/tinymistral-248m-sft-v4.q8_0.gguf",
  ...
  {
    url:
      "https://huggingface.co/TKDKid1000/phi-1_5-GGUF/resolve/main/phi-1_5-Q4_K_M.gguf",
    label: "microsoft/phi-1_5 Q4_K_M (918 MB)",
  },
  {
    url:
      "https://huggingface.co/Qwen/Qwen1.5-1.8B-Chat-GGUF/resolve/main/qwen1_5-1_8b-chat-q3_k_m.gguf",
  ...
  {
    url:
      "https://huggingface.co/mradermacher/Qwen3-8B-Josiefied-iSMART-GGUF/resolve/main/Qwen3-8B-Josiefied-iSMART.Q2_K.gguf",
    label: "Qwen3 8B Josiefied iSMART (3.28 GB)",
  },
];
...
export default function App() {
  ...
  console.log("WebGPU supported:", navigator.gpu.wgslLanguageFeatures.size);
